...
| 唯一入口 | 从 [Part 01](Part01-实验准备.md) 开始；每关结束后更新项目 README、实验日志并提交 Git |
...
每关产生的文件、版本、原始输出、失败案例和结论都应能映射到课程的[Evidence Manifest](../../learning/10_Assessment_and_Submission.md#evidence-manifest)。
