...
|:---:|---|---|---|
| ⭐⭐⭐⭐⭐ | 🤖 **Large Language Models & AI Agents** | **中文首选推荐。** 系统介绍大语言模型、Prompt Engineering、AI Agent、多模态模型等内容，实验室统一入门教材。 | https://nndl.ai/llm-agent/ |
| ⭐⭐⭐⭐⭐ | 🤖 **Hello-Agents** | **AI Agent 实践首选。** 从零开始构建 AI Agent，涵盖 Memory、Tool Calling、MCP、LangGraph、多智能体等前沿内容。 | https://helloagents.org/ |
...
| ⭐⭐⭐⭐☆ | 👨‍🏫 **Stanford CS336 – Language Modeling** | **国际顶级课程。** Stanford 最新大语言模型课程，深入讲解 LLM 的训练、推理、优化与系统设计，适合作为进阶学习资源。 | https://cs336.stanford.edu/ |
